...
def update_schedule(schedule: dict, common: dict, prefix: str, calendar_name: str):
    ...
    target_id = __get_target_id(cal_service, calendar_name)

    # noinspection PyTypeChecker
    __clear_events(cal_service, target_id)
    __register_schedule(cal_service, target_id, schedule, common)
...
# noinspection PyUnresolvedReferences
def __get_target_id(service: Resource, calendar_name: str):
